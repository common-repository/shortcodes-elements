...
<div class="container">
 <form action="/" method="get" accept-charset="utf-8">
	 <div class="row">
		 <div class="col-25">
			 <label for="country"><?php esc_html_e("Select Style","selements"); ?></label>
		 </div>
		 <div class="col-75">
			 <select name="tabs_style" id="tabs_style" size="1">
				<option value="1" selected="selected"><?php esc_html_e("one","selements"); ?></option>
				<option value="2"><?php esc_html_e("Two","selements"); ?></option>
		 </select>
		 </div>
	 </div>
	 ...
	 <div class="row">
		 <div class="col-25">
			 <label for="country"><?php esc_html_e("Tab field","selements"); ?></label>
		 </div>
		 <div class="col-75">
			 <input type="button" onclick="addtabs()" class="shortcode-button" name="add" id="more"  value="<?php esc_attr_e("Add Tab Field","selements"); ?>" />
		 </div>
		 <input type="button" onclick="remove_tabs()" class="remove-button" name="remove_buttonn" id="remove_buttonn"  value="<?php esc_attr_e("Remove Last Tab Feild","selements"); ?>" style="display:none;" />
	 </div>
	 <div class="row">
		 <div class="col-25">
			 <input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_tabs" style="display: block;">
		 </div>
	 </div>
 </form>
</div>
