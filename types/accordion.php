...
<div class="container">
  <form action="/" method="get" accept-charset="utf-8">
    <div class="row" id="textaccordion">
		...
		<div class="row">
			<div class="col-25">
				<label for="country"><?php esc_html_e("Accordion field","selements"); ?></label>
			</div>
			<div class="col-75">
				<input type="button" onclick="addInputt()" class="shortcode-button" name="add" id="more"  value="<?php esc_attr_e("Add Accordion Field","selements"); ?>" />
			</div>
      <input type="button" onclick="remove_fieldd()" class="remove-button" name="remove_button" id="remove_button"  value="<?php esc_attr_e("Remove Last Field","selements"); ?>" style="display:none;" />
		</div>
    <div class="row">
			<div class="col-25">
      	<input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_accor" style="display: block;">
    	</div>
		</div>
  </form>
</div>
