...
<div class="container">
  <form action="/" method="get" accept-charset="utf-8">
    <div class="row">
      <div class="col-25">
        <label for="lname"><?php esc_html_e("Media Images","selements"); ?></label>
      </div>
      <div class="col-75">
      ...
      <div class="col-75" style="float: right;">
        ...
        <input type="button" name="upload-btn" id="upload-btn-gallery" class="button-secondary button" value="<?php esc_attr_e("Upload Image","selements"); ?>">
      </div>
 	</div>
 	<div class="row">
      <div class="col-25">
        <label for="lname"><?php esc_html_e("Gallery Style","selements"); ?></label>
      </div>
      <div class="col-75">
      <select class="slider_type" name="gallery_type" id="gallery_type">
      	<option value="one"><?php esc_html_e("Gallery 1","selements"); ?></option>
      	<option value="two"><?php esc_html_e("Gallery 2","selements"); ?></option>
      	<option value="three"><?php esc_html_e("Gallery 3","selements"); ?></option>
      </select>
      </div>
 	</div>
 	<div class="row">
		...
		<div class="col-75">
			<input class="input-medium" placeholder="<?php esc_attr_e("Extra class","selements"); ?>" type="text" id="gallery_class" value="" name="gallery_class"/>
		</div>
	</div>
    <div class="row">
			<div class="col-25">
        <input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_gallery" style="display: block;">
    	</div>
	</div>
  </form>
</div>
