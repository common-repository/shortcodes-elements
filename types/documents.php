...
<div class="container">
  <form action="/" method="get" accept-charset="utf-8">
    <div class="row">
      <div class="col-25">
        <label for="lname"><?php esc_html_e("Media Manager","selements"); ?></label>
      </div>
      <div class="col-75">
      ...
      <div class="col-75" style="float: right;">
        ...
        <input type="button" name="upload-btn" id="upload-btn-doc" class="button-secondary button" value="<?php esc_attr_e("Upload Document","selements"); ?>">
      </div>
 	</div>
	<div class="row">
			<div class="col-25">
			...
			<div class="col-75">
				...
				<span>
				<output id="outputt" for="documents_width"><?php esc_html_e("600","selements"); ?></output></span>
			</div>
		</div>
		<div class="row">
			<div class="col-25">
			...
			<div class="col-75">
				...
				<span>
				<output id="output" for="documents_height"><?php esc_html_e("400","selements"); ?></output></span>
			</div>
		</div>
 	<div class="row">
		<div class="col-25">
		...
		<div class="col-75">
			<input class="input-medium" placeholder="<?php esc_attr_e("Extra class","selements"); ?>" type="text" id="documents_class" value="" name="documents_class"/>
		</div>
	</div>
    <div class="row">
			<div class="col-25">
        <input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_doc" style="display: block;">
    	</div>
	</div>
  </form>
</div>
