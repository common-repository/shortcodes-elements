  ...
  <form action="/" method="get" accept-charset="utf-8">
    <div class="row">
      ...
      <div class="col-75">
		...
		<div class="row">
			<div class="col-25">
				<label for="lname"><?php esc_html_e("Align","selements"); ?></label>
			</div>
			<div class="col-75">
		...
		<div class="row">
		 <div class="col-25">
			 <label for="country"><?php esc_html_e("media","selements"); ?></label>
		 </div>
		<div class="col-75">
        <input type="text" placeholder="<?php esc_attr_e("Image URL","selements"); ?>" name="frame_content" id="frame_content" class="regular-text">
        <input type="button" name="upload-btn" id="upload-btn-frame" class="button-secondary button" value="<?php esc_attr_e("Upload Image","selements"); ?>">
    ...
    <div class="row">
			<div class="col-25">
      	<input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_frame" style="display: block;">
    	</div>
		</div>
  </form>
</div>
