...
<div class="container">
  <form action="/" method="get" accept-charset="utf-8">
		<div class="row">
			...
			<div class="col-75">
				<input class="input-medium" placeholder="<?php esc_attr_e("Expand title","selements"); ?>" type="text" id="expand_heading" value="" name="expand_heading">
			</div>
		</div>
		<div class="row">
			<div class="col-25">
				<label for="lname"><?php esc_html_e("Show more button title","selements"); ?></label>
			</div>
			<div class="col-75">
				<input class="input-medium" placeholder="<?php esc_attr_e("Show more button title","selements"); ?>" type="text" id="show_more_title" value="" name="show_more_title">
			</div>
		</div>
		<div class="row">
			<div class="col-25">
				<label for="lname"><?php esc_html_e("Show less button title","selements"); ?></label>
			</div>
			<div class="col-75">
				<input class="input-medium" placeholder="<?php esc_attr_e("Show more button title","selements"); ?>" type="text" id="show_less_title" value="" name="show_less_title">
			</div>
		</div>
		<div class="row">
			<div class="col-25">
				<label for="lname"><?php esc_html_e("Enter Show less content","selements"); ?></label>
			</div>
			<div class="col-75">
		...
		<div class="row">
			<div class="col-25">
				<label for="fname"><?php esc_html_e("Enter Show more content","selements"); ?></label>
			</div>
			<div class="col-75">
		...
		<div class="row">
			...
			<div class="col-75">
				<input class="input-medium" placeholder="<?php esc_attr_e("Class","selements"); ?>" type="text" id="expend_class" name="expend_class" value="">
			</div>
		</div>
		<div class="row">
			<div class="col-25">
				<input class="btn custom_button_shortcode" value="<?php esc_attr_e("Insert","selements"); ?>" name="" id="insert_expand" style="display: block;">
			</div>
		</div>
  </form>
</div>